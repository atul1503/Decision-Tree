...
attributeNames,data=readData(fileName,delim,int(float(input("Enter the no. of data sets to skip ; or press ENTER : ") or 0)),int(float(input('Enter the no. of training data sets :'))))
